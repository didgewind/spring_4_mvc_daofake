...
@Repository(value="daoJdbcNoTry")
//@Primary
@Lazy
public class EmpDAOJdbcSinControlDeErrores implements EmpDAO {
	...
	private Logger logger = Logger.getLogger(EmpDAOJdbcSinControlDeErrores.class
			.getName());
...
//	@Transactional(propagation=Propagation.REQUIRES_NEW)
	...
	public String[] getAllHobbies() {
		...
		String[] aReturn = {"Ir a encuentros Rainbow", "Practicar el no apego", "Bailar el Despacito"};
		return aReturn;
	}
